...
def Run(args):
    ...
    # SAMPLING_SERVER_BIN: override which built binary to launch
    server_bin = os.environ.get("SAMPLING_SERVER_BIN", os.path.join(Legion_home, "sampling_server/build/bin/sampling_server"))
    server_path = "{} {} {}".format(server_bin, gpu_number, cache_agg_mode)
